...
namespace trtxlayers {
    ...
    IConcatenationLayer *mixed_3a(INetworkDefinition *network, std::map<std::string, Weights> &weightMap, ITensor &input, std::string lname) {
        // branch0
    ...
    IConcatenationLayer* mixed_4a(INetworkDefinition *network, std::map<std::string, Weights>& weightMap, ITensor& input, std::string lname) {
        // branch 0
    ...
    IConcatenationLayer* mixed_5a(INetworkDefinition *network, std::map<std::string, Weights>& weightMap, ITensor& input, std::string lname) {
        //branch 0
    ...
    IConcatenationLayer* reductionA(INetworkDefinition *network, std::map<std::string, Weights>& weightMap, ITensor& input, std::string lname) {
    ...
    IConcatenationLayer* reductionB(INetworkDefinition *network, std::map<std::string, Weights>& weightMap, ITensor& input, std::string lname) {
