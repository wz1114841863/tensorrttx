...
IConcatenationLayer *fire(INetworkDefinition *network, std::map<std::string, Weights> &weightMap, 
        ITensor &input, std::string lname, int squeeze_planes, int e1x1_planes, int e3x3_planes) {
